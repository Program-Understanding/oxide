...
# This file includes portions of the cpu_rec tool, with modifications.
# 
# The original cpu_rec tool was developed by Airbus Security Lab:
# https://github.com/airbus-seclab/cpu_rec
# 
# This implementation is based on a fork of the original repository:
# https://github.com/thezeroalpha/cpu_rec
# 
# Modifications have been made to adapt the code for this project.
# 
# The code is licensed under the Apache License 2.0. A copy of the license can
# be found in the LICENSE file at the root of this repository or at
# http://www.apache.org/licenses/LICENSE-2.0.
# 
# Changes from the original and forked repositories have been documented
